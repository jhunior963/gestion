    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <button type="button" style="margin-bottom: 24px" class="btn btn-success btn-sm" data-toggle="modal" data-target="#ModalUpdate{{ $materia->id}}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="nombre" value="{{ old('nombre', $materia->nombre)}}" placeholder="Escriba aqui..." required>
                                                    </div>
                                                    @error('nombre')
                                                    <small style="color: red">{{$message}}</small>
                                                    @enderror
